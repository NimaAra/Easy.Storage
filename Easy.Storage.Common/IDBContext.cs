namespace Easy.Storage.Common
{
    ...
    public interface IDBContext<T>
    {
        ...
        /// </summary>
        Task<IList<T>> Get(IDbTransaction transaction = null);
        ...
        Task<IList<T>> GetWhere<TProperty>(Expression<Func<T, TProperty>> selector, TProperty value, IDbTransaction transaction = null);
        ...
        Task<IList<T>> GetWhere<TProperty>(Expression<Func<T, TProperty>> selector, IDbTransaction transaction = null, params TProperty[] values);
        ...
        Task<IList<T>> GetWhere(Filter<T> filter, IDbTransaction transaction = null);
