    ...
    internal sealed class SqliteRepositoryTests : Context
    {
        ...
        public async Task When_getting_non_aliased_models_lazily()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                insertedPeopleBuffered[0].Id.ShouldBe((ulong)1);
                insertedPeopleBuffered[0].Name.ShouldBe("P1");
                insertedPeopleBuffered[0].Age.ShouldBe((uint)10);

                insertedPeopleBuffered[1].Id.ShouldBe((ulong)2);
                insertedPeopleBuffered[1].Name.ShouldBe("P2");
                insertedPeopleBuffered[1].Age.ShouldBe((uint)20);

                insertedPeopleBuffered[2].Id.ShouldBe((ulong)3);
                insertedPeopleBuffered[2].Name.ShouldBe("P3");
                insertedPeopleBuffered[2].Age.ShouldBe((uint)30);

                insertedPeopleBuffered[3].Id.ShouldBe((ulong)4);
                insertedPeopleBuffered[3].Name.ShouldBe("P4");
                insertedPeopleBuffered[3].Age.ShouldBe((uint)40);

                insertedPeopleUnBuffered[0].Id.ShouldBe((ulong)1);
                insertedPeopleUnBuffered[0].Name.ShouldBe("P1");
                insertedPeopleUnBuffered[0].Age.ShouldBe((uint)10);

                insertedPeopleUnBuffered[1].Id.ShouldBe((ulong)2);
                insertedPeopleUnBuffered[1].Name.ShouldBe("P2");
                insertedPeopleUnBuffered[1].Age.ShouldBe((uint)20);

                insertedPeopleUnBuffered[2].Id.ShouldBe((ulong)3);
                insertedPeopleUnBuffered[2].Name.ShouldBe("P3");
                insertedPeopleUnBuffered[2].Age.ShouldBe((uint)30);

                insertedPeopleUnBuffered[3].Id.ShouldBe((ulong)4);
                insertedPeopleUnBuffered[3].Name.ShouldBe("P4");
                insertedPeopleUnBuffered[3].Age.ShouldBe((uint)40);
            }
        }
        ...
        public async Task When_getting_aliased_models_lazily()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                insertedPeopleBuffered[0].SomeId.ShouldBe((ulong)1);
                insertedPeopleBuffered[0].SomeName.ShouldBe("P1");
                insertedPeopleBuffered[0].Age.ShouldBe((uint)10);

                insertedPeopleBuffered[1].SomeId.ShouldBe((ulong)2);
                insertedPeopleBuffered[1].SomeName.ShouldBe("P2");
                insertedPeopleBuffered[1].Age.ShouldBe((uint)20);

                insertedPeopleBuffered[2].SomeId.ShouldBe((ulong)3);
                insertedPeopleBuffered[2].SomeName.ShouldBe("P3");
                insertedPeopleBuffered[2].Age.ShouldBe((uint)30);

                insertedPeopleBuffered[3].SomeId.ShouldBe((ulong)4);
                insertedPeopleBuffered[3].SomeName.ShouldBe("P4");
                insertedPeopleBuffered[3].Age.ShouldBe((uint)40);

                insertedPeopleUnBuffered[0].SomeId.ShouldBe((ulong)1);
                insertedPeopleUnBuffered[0].SomeName.ShouldBe("P1");
                insertedPeopleUnBuffered[0].Age.ShouldBe((uint)10);

                insertedPeopleUnBuffered[1].SomeId.ShouldBe((ulong)2);
                insertedPeopleUnBuffered[1].SomeName.ShouldBe("P2");
                insertedPeopleUnBuffered[1].Age.ShouldBe((uint)20);

                insertedPeopleUnBuffered[2].SomeId.ShouldBe((ulong)3);
                insertedPeopleUnBuffered[2].SomeName.ShouldBe("P3");
                insertedPeopleUnBuffered[2].Age.ShouldBe((uint)30);

                insertedPeopleUnBuffered[3].SomeId.ShouldBe((ulong)4);
        ...
        public async Task When_getting_non_aliased_models_by_selector()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                var onePerson = (await repo.GetAsync(p => p.Id, (ulong)1)).ToArray();

                onePerson.Length.ShouldBe(1);
                onePerson[0].Id.ShouldBe((ulong)1);
                onePerson[0].Name.ShouldBe("P1");
                onePerson[0].Age.ShouldBe((uint)10);

                var peopleWithSameName = (await repo.GetAsync(p => p.Name, "P5")).ToArray();

                peopleWithSameName.Length.ShouldBe(2);
                peopleWithSameName[0].Id.ShouldBe((ulong)5);
                peopleWithSameName[0].Name.ShouldBe("P5");
                peopleWithSameName[0].Age.ShouldBe((uint)40);

                peopleWithSameName[1].Id.ShouldBe((ulong)6);
                peopleWithSameName[1].Name.ShouldBe("P5");
                peopleWithSameName[1].Age.ShouldBe((uint)10);

                var peopleWithSameAge = (await repo.GetAsync(p => p.Age, (uint)10)).ToArray();

                peopleWithSameAge.Length.ShouldBe(3);
                peopleWithSameAge[0].Id.ShouldBe((ulong)1);
                peopleWithSameAge[0].Name.ShouldBe("P1");
                peopleWithSameAge[0].Age.ShouldBe((uint)10);

                peopleWithSameAge[1].Id.ShouldBe((ulong)4);
                peopleWithSameAge[1].Name.ShouldBe("P4");
                peopleWithSameAge[1].Age.ShouldBe((uint)10);

                peopleWithSameAge[2].Id.ShouldBe((ulong)6);
                peopleWithSameAge[2].Name.ShouldBe("P5");
                peopleWithSameAge[2].Age.ShouldBe((uint)10);

                var peopleWithDifferentNames = (await repo.GetAsync(p => p.Name, null, "P1", "P2")).ToArray();

                peopleWithDifferentNames.Length.ShouldBe(2);

                peopleWithDifferentNames[0].Id.ShouldBe((ulong)1);
                peopleWithDifferentNames[0].Name.ShouldBe("P1");
                peopleWithDifferentNames[0].Age.ShouldBe((uint)10);

                peopleWithDifferentNames[1].Id.ShouldBe((ulong)2);
                peopleWithDifferentNames[1].Name.ShouldBe("P2");
                peopleWithDifferentNames[1].Age.ShouldBe((uint)20);

                var nonExistingPeople = (await repo.GetAsync(p => p.Age, (uint)60)).ToArray();
        ...
        public async Task When_getting_aliased_models_by_selector()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                var onePerson = (await repo.GetAsync(p => p.SomeId, (ulong)1)).ToArray();

                onePerson.Length.ShouldBe(1);
                onePerson[0].SomeId.ShouldBe((ulong)1);
                ...
                peopleWithSameName.Length.ShouldBe(2);
                peopleWithSameName[0].SomeId.ShouldBe((ulong)5);
                peopleWithSameName[0].SomeName.ShouldBe("P5");
                peopleWithSameName[0].Age.ShouldBe((uint)40);

                peopleWithSameName[1].SomeId.ShouldBe((ulong)6);
                ...
                peopleWithSameAge.Length.ShouldBe(3);
                peopleWithSameAge[0].SomeId.ShouldBe((ulong)1);
                peopleWithSameAge[0].SomeName.ShouldBe("P1");
                peopleWithSameAge[0].Age.ShouldBe((uint)10);

                peopleWithSameAge[1].SomeId.ShouldBe((ulong)4);
                peopleWithSameAge[1].SomeName.ShouldBe("P4");
                peopleWithSameAge[1].Age.ShouldBe((uint)10);

                peopleWithSameAge[2].SomeId.ShouldBe((ulong)6);
                ...
                peopleWithDifferentNames[0].SomeId.ShouldBe((ulong)1);
                peopleWithDifferentNames[0].SomeName.ShouldBe("P1");
                peopleWithDifferentNames[0].Age.ShouldBe((uint)10);

                peopleWithDifferentNames[1].SomeId.ShouldBe((ulong)2);
        ...
        public async Task When_getting_non_aliased_models_by_filter()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                filter1.And(p => p.Age, Operand.GreaterThan, (uint)30);
                filter1.Or(p => p.Name, Operand.Equal, "P1");

                var filter1Result = (await repo.GetAsync(filter1)).ToArray();
                filter1Result.Length.ShouldBe(3);

                filter1Result[0].Id.ShouldBe((ulong)1);
                filter1Result[0].Name.ShouldBe("P1");
                filter1Result[0].Age.ShouldBe((uint)10);

                filter1Result[1].Id.ShouldBe((ulong)5);
                filter1Result[1].Name.ShouldBe("P5");
                filter1Result[1].Age.ShouldBe((uint)40);

                filter1Result[2].Id.ShouldBe((ulong)6);
                filter1Result[2].Name.ShouldBe("P5");
                filter1Result[2].Age.ShouldBe((uint)50);

                var filter2 = new QueryFilter<Person>();
                filter2.And(p => p.Age, Operand.GreaterThanOrEqual, (uint)50);
                filter2.Or(p => p.Age, Operand.Equal, (uint)20);

                var filter2Result = (await repo.GetAsync(filter2)).ToArray();
                filter2Result.Length.ShouldBe(2);

                filter2Result[0].Id.ShouldBe((ulong)2);
                filter2Result[0].Name.ShouldBe("P2");
                filter2Result[0].Age.ShouldBe((uint)20);

                filter2Result[1].Id.ShouldBe((ulong)6);
                filter2Result[1].Name.ShouldBe("P5");
                filter2Result[1].Age.ShouldBe((uint)50);
            }
        }
        ...
        public async Task When_inserting_single_non_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                insertedP1.Id.ShouldBe((ulong)1);
                insertedP1.Name.ShouldBe("P1");
                insertedP1.Age.ShouldBe((uint)10);
                ...
                var insertedP2 = (await repo.GetAsync(p => p.Id, (ulong)2)).Single();
                insertedP2.ShouldNotBeNull();
                insertedP2.Id.ShouldBe((ulong)2);
                insertedP2.Name.ShouldBe("P2");
                insertedP2.Age.ShouldBe((uint)20);
                ...
                var insertedP3 = (await repo.GetAsync(p => p.Id, (ulong)3)).Single();
                insertedP3.ShouldNotBeNull();
                insertedP3.Id.ShouldBe((ulong)3);
                insertedP3.Name.ShouldBe("P3");
                insertedP3.Age.ShouldBe((uint)30);
                ...
                var insertedP4 = (await repo.GetAsync(p => p.Id, (ulong)4)).Single();
                insertedP4.ShouldNotBeNull();
                insertedP4.Id.ShouldBe((ulong)4);
                insertedP4.Name.ShouldBe("P4");
                insertedP4.Age.ShouldBe((uint)40);
            }
        }
        ...
        public async Task When_inserting_single_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                var insertedP1 = (await repo.GetAsync()).Single();
                insertedP1.ShouldNotBeNull();
                insertedP1.SomeId.ShouldBe((ulong)1);
                ...
                var insertedP2 = (await repo.GetAsync(p => p.SomeId, (ulong)2)).Single();
                insertedP2.ShouldNotBeNull();
                insertedP2.SomeId.ShouldBe((ulong)2);
                ...
                var insertedP3 = (await repo.GetAsync(p => p.SomeId, (ulong)3)).Single();
                insertedP3.ShouldNotBeNull();
                insertedP3.SomeId.ShouldBe((ulong)3);
                ...
                var insertedP4 = (await repo.GetAsync(p => p.SomeId, (ulong)4)).Single();
                insertedP4.ShouldNotBeNull();
                insertedP4.SomeId.ShouldBe((ulong)4);
        ...
        public async Task When_inserting_multiple_non_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                p1.Id.ShouldBe((ulong)1);
                p1.Name.ShouldBe("P1");
                p1.Age.ShouldBe((uint)10);

                var p2 = insertedPeople[1];
                p2.Id.ShouldBe((ulong)2);
                p2.Name.ShouldBe("P2");
                p2.Age.ShouldBe((uint)20);

                var p3 = insertedPeople[2];
                p3.Id.ShouldBe((ulong)3);
                p3.Name.ShouldBe("P3");
                p3.Age.ShouldBe((uint)30);

                var p4 = insertedPeople[3];
                p4.Id.ShouldBe((ulong)4);
                p4.Name.ShouldBe("P4");
                p4.Age.ShouldBe((uint)40);
            }
        }
        ...
        public async Task When_inserting_multiple_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                var p1 = insertedPeople[0];
                p1.SomeId.ShouldBe((ulong)1);
                p1.SomeName.ShouldBe("P1");
                p1.Age.ShouldBe((uint)10);

                var p2 = insertedPeople[1];
                p2.SomeId.ShouldBe((ulong)2);
                p2.SomeName.ShouldBe("P2");
                p2.Age.ShouldBe((uint)20);

                var p3 = insertedPeople[2];
                p3.SomeId.ShouldBe((ulong)3);
                p3.SomeName.ShouldBe("P3");
                p3.Age.ShouldBe((uint)30);

                var p4 = insertedPeople[3];
                p4.SomeId.ShouldBe((ulong)4);
        ...
        public async Task When_updating_single_by_id_non_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                updatedP1.Age.ShouldBe((uint)60);
        ...
        public async Task When_updating_custom_non_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                (await repo.UpdateAsync(template1, p => p.Age, (ulong)10)).ShouldBe(1);

                var snapshot1 = (await repo.GetAsync()).ToArray();
                snapshot1.Length.ShouldBe(insertedPeople.Length);

                snapshot1[0].Id.ShouldBe((ulong)1);
                snapshot1[0].Name.ShouldBe("P0");
                snapshot1[0].Age.ShouldBe((uint)0);
                ...
                snapshot2[4].Id.ShouldBe((ulong)5);
                snapshot2[4].Name.ShouldBe("P100");
                snapshot2[4].Age.ShouldBe((uint)100);

                snapshot2[5].Id.ShouldBe((ulong)6);
                snapshot2[5].Name.ShouldBe("P100");
                snapshot2[5].Age.ShouldBe((uint)100);

                snapshot2[6].Id.ShouldBe((ulong)7);
                snapshot2[6].Name.ShouldBe("P100");
                snapshot2[6].Age.ShouldBe((uint)100);

                var template3 = new Person { Name = "P200", Age = 200 };
                (await repo.UpdateAsync(template3, p => p.Id, null, (ulong) 1, (ulong) 2, (ulong) 3)).ShouldBe(3);

                var snapshot3 = (await repo.GetAsync()).ToArray();
                snapshot3.Length.ShouldBe(insertedPeople.Length);

                snapshot3[0].Id.ShouldBe((ulong)1);
                snapshot3[0].Name.ShouldBe("P200");
                snapshot3[0].Age.ShouldBe((uint)200);

                snapshot3[1].Id.ShouldBe((ulong)2);
                snapshot3[1].Name.ShouldBe("P200");
                snapshot3[1].Age.ShouldBe((uint)200);

                snapshot3[2].Id.ShouldBe((ulong)3);
                snapshot3[2].Name.ShouldBe("P200");
                snapshot3[2].Age.ShouldBe((uint)200);
        ...
        public async Task When_updating_custom_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                snapshot1[0].SomeId.ShouldBe((ulong)1);
                ...
                snapshot2[4].SomeId.ShouldBe((ulong)5);
                snapshot2[4].SomeName.ShouldBe("P100");
                snapshot2[4].Age.ShouldBe((uint)100);

                snapshot2[5].SomeId.ShouldBe((ulong)6);
                snapshot2[5].SomeName.ShouldBe("P100");
                snapshot2[5].Age.ShouldBe((uint)100);

                snapshot2[6].SomeId.ShouldBe((ulong)7);
                snapshot2[6].SomeName.ShouldBe("P100");
                snapshot2[6].Age.ShouldBe((uint)100);

                var template3 = new MyPerson { SomeName = "P200", Age = 200 };
                (await repo.UpdateAsync(template3, p => p.SomeId, null, (ulong)1, (ulong)2, (ulong)3)).ShouldBe(3);

                var snapshot3 = (await repo.GetAsync()).ToArray();
                snapshot3.Length.ShouldBe(insertedPeople.Length);

                snapshot3[0].SomeId.ShouldBe((ulong)1);
                snapshot3[0].SomeName.ShouldBe("P200");
                snapshot3[0].Age.ShouldBe((uint)200);

                snapshot3[1].SomeId.ShouldBe((ulong)2);
                snapshot3[1].SomeName.ShouldBe("P200");
                snapshot3[1].Age.ShouldBe((uint)200);

                snapshot3[2].SomeId.ShouldBe((ulong)3);
        ...
        public async Task When_updating_multiple_non_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                p1.Age.ShouldBe((uint)20);

                var p2 = allPeople[1];
                p2.Id.ShouldBe((ulong)2);
                p2.Name.ShouldBe("P2-updated");
                p2.Age.ShouldBe((uint)40);

                var p3 = allPeople[2];
                p3.Id.ShouldBe((ulong)3);
                p3.Name.ShouldBe("P3-updated");
                p3.Age.ShouldBe((uint)60);

                var p4 = allPeople[3];
                p4.Id.ShouldBe((ulong)4);
                p4.Name.ShouldBe("P4-updated");
                p4.Age.ShouldBe((uint)80);

                var p5 = allPeople[4];
                p5.Id.ShouldBe((ulong)5);
        ...
        public async Task When_deleting_non_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                (await repo.GetAsync(p => p.Id, (ulong)1)).ShouldNotBeEmpty();
                (await repo.DeleteAsync(p => p.Id, (ulong)1)).ShouldBe(1);
                (await repo.GetAsync()).Count().ShouldBe(3);
                (await repo.GetAsync(p => p.Id, (ulong)1)).ShouldBeEmpty();

                (await repo.GetAsync(p => p.Age, (uint)30)).Count().ShouldBe(2);
                (await repo.DeleteAsync(p => p.Age, (uint)30)).ShouldBe(2);
                (await repo.GetAsync()).Count().ShouldBe(1);
                (await repo.GetAsync(p => p.Age, (uint)30)).ShouldBeEmpty();

                var remainingPeople = (await repo.GetAsync()).Single();
                remainingPeople.Id.ShouldBe((ulong)2);
                remainingPeople.Name.ShouldBe("P2");
                remainingPeople.Age.ShouldBe((uint)20);
        ...
        public async Task When_deleting_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                (await repo.GetAsync(p => p.SomeId, (ulong)1)).ShouldNotBeEmpty();
                (await repo.DeleteAsync(p => p.SomeId, (ulong)1)).ShouldBe(1);
                (await repo.GetAsync()).Count().ShouldBe(3);
                (await repo.GetAsync(p => p.SomeId, (ulong)1)).ShouldBeEmpty();
                ...
                var remainingPeople = (await repo.GetAsync()).Single();
                remainingPeople.SomeId.ShouldBe((ulong)2);
        ...
        public async Task When_min_non_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                (await repo.MinAsync(p => p.Id)).ShouldBe((ulong)0);
                (await repo.MinAsync(p => p.Age)).ShouldBe((uint)0);
                ...
                (await repo.MinAsync(p => p.Id)).ShouldBe((ulong)1);
                (await repo.MinAsync(p => p.Age)).ShouldBe((uint)10);
        ...
        public async Task When_min_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                (await repo.MinAsync(p => p.SomeId)).ShouldBe((ulong)0);
                (await repo.MinAsync(p => p.Age)).ShouldBe((uint)0);
                ...
                (await repo.MinAsync(p => p.SomeId)).ShouldBe((ulong)1);
                (await repo.MinAsync(p => p.Age)).ShouldBe((uint)10);
        ...
        public async Task When_max_non_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                (await repo.MaxAsync(p => p.Id)).ShouldBe((ulong)0);
                (await repo.MaxAsync(p => p.Age)).ShouldBe((uint)0);
                ...
                (await repo.MaxAsync(p => p.Id)).ShouldBe((ulong)4);
                (await repo.MaxAsync(p => p.Age)).ShouldBe((uint)30);
        ...
        public async Task When_max_aliased_model()
        {
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:"))
            {
                ...
                (await repo.MaxAsync(p => p.SomeId)).ShouldBe((ulong)0);
                (await repo.MaxAsync(p => p.Age)).ShouldBe((uint)0);
                ...
                (await repo.MaxAsync(p => p.SomeId)).ShouldBe((ulong)4);
                (await repo.MaxAsync(p => p.Age)).ShouldBe((uint)30);
        ...
        public async Task When_doing_multiple_operations_with_sample_model()
        {
            ...
            using (IDatabase db = new SqliteDatabase("Data Source=:memory:;binaryguid=False;"))
            {
                ...
                insertedSample1.Id.ShouldBe((ulong)1);
